          ...
          <div class="row g-0">
            ...
            <div class="col app-calendar-sidebar border-end" id="app-calendar-sidebar">
              ...
              <div class="p-4">
                ...
                <!-- Filter -->
                <div class="mb-4">
                  <small class="text-small text-muted text-uppercase align-middle">필터</small>
                </div>
                ...
                <div class="app-calendar-events-filter">
                  <div class="form-check form-check-danger mb-3">
                    <input
                            ...
                            data-value="personal"
                            checked />
                    <label class="form-check-label" for="select-personal">업무</label>
                  </div>
                  <div class="form-check mb-3">
                    <input
                            ...
                            data-value="business"
                            checked />
                    <label class="form-check-label" for="select-business">개인 일정</label>
                  </div>
                  <div class="form-check form-check-warning mb-3">
                    <input
                            ...
                            data-value="family"
                            checked />
                    <label class="form-check-label" for="select-family">출장</label>
                  </div>
                ...
                <div class="offcanvas-body">
                  <form class="event-form pt-0" id="eventForm" onsubmit="return false">
                    <div class="form-floating form-floating-outline mb-4">
                      <a href="/smc/"><button type="button" class="btn btn-label-primary btn-fab demo">
                        <span class="tf-icons mdi mdi-checkbox-marked-circle-outline me-1"></span>작성하러 바로가기
                    </button></a>
                    </div>
                    ...
                    <div class="form-floating form-floating-outline mb-4">
                      <select class="select2 select-event-label form-select" id="eventLabel" name="eventLabel">
                        <option data-label="primary" value="Business" selected>개인 일정</option>
                        <option data-label="danger" value="Personal">업무</option>
                        <option data-label="warning" value="Family">출장</option>
                        <option data-label="success" value="Holiday">상담 업무</option>
                        <option data-label="info" value="ETC">기타</option>
                      </select>
                      <label for="eventLabel">분류</label>
                    </div>
                    <div class="form-floating form-floating-outline mb-4">
                      <input
                              type="text"
                      ...
                      <label for="eventStartDate">시작 일자</label>
                    </div>
                    <div class="form-floating form-floating-outline mb-4">
                      <input
                              type="text"
                      ...
                      <label for="eventEndDate">종료 일자</label>
                    </div>
                    <div class="mb-3">
                      <label class="switch">
                    ...
                    <div class="form-floating form-floating-outline mb-4 select2-primary">
                      <select
                              ...
                              name="eventGuests"
                              multiple>
                        <option data-avatar="1.png" value="Jane Foster">김국민</option>
                        <option data-avatar="5.png" value="Gabrielle Robertson">권현진</option>
                        <option data-avatar="7.png" value="Lori Spears">박효선</option>
                        <option data-avatar="9.png" value="Sandy Vega">서민철</option>
                        <option data-avatar="11.png" value="Cheryl May">오지예</option>
                      </select>
                      <label for="eventGuests">담당자</label>
                    </div>
                    <div class="form-floating form-floating-outline mb-4">
                      <input
                              type="text"
                    ...
                    <div class="form-floating form-floating-outline mb-4">
                      ...
                      <label for="eventDescription">상세 설명</label>
                    </div>
                    <div class="mb-3 d-flex justify-content-sm-between justify-content-start my-4 gap-2">
                      <div class="d-flex">
                        <button type="submit" class="btn btn-primary btn-add-event me-sm-2 me-1">추가</button>
                        <button
                                type="reset"
                      ...
                      <button class="btn btn-outline-danger btn-delete-event d-none">일정 삭제</button>
                    </div>
                  </form>
                </div>
              </div>
