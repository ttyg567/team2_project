...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 mb-4"><span class="text-muted fw-light">Wizard examples /</span> Create Deal</h4>
                        ...
                        <div class="row g-4">
                            <div class="col-12">
                                <img
                                        ...
                                        src="../../assets/img/illustrations/shopping-girl.png"
                                        alt="Shopping Girl" />
                            </div>
                            <div class="col-12">
                                <div class="row">
                                  ...
                                  <span class="custom-option-body">
                                    ...
                                    <span class="custom-option-title">민원</span>
                                    <small>민원 고객에게 사과의 편지를 작성중이시라면!</small>
                                  </span>
                                                <input
                                  ...
                                  <span class="custom-option-body">
                                    ...
                                    <small>업체에 마케팅 자료를 전송할 메일을 작성중이시라면!</small>
                                  </span>
                                                <input
                                                        name="customRadioIcon"
                                                        class="form-check-input"
                                  ...
                                  <span class="custom-option-body">
                                    ...
                                    <small>추가로 필요한 양식이 있다면 요청해주세요 ^^! </small>
                                  </span>
                                                <input
                                                        name="customRadioIcon"
                                                        class="form-check-input"
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-sm-6">
                                <div class="form-floating form-floating-outline">
                                    <input
                                            type="number"
                                            id="dealMinimumCartAmount"
                                            name="dealMinimumCartAmount"
                                            class="form-control"
                                            placeholder="$99" />
                            ...
                            <div class="col-sm-6">
                                <div class="form-floating form-floating-outline">
                                    <input
                                            type="number"
                                            id="dealPromotionalFee"
                                            name="dealPromotionalFee"
                                            class="form-control"
                                            placeholder="$9" />
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-lg-6 d-flex align-items-center justify-content-center">
                                <img
                                        ...
                                        src="../../assets/img/illustrations/create-deal-review-complete.png"
